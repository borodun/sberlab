...
func makeRequest() {
	...
	req, _ := http.NewRequest("GET", "https://ecss.ru-moscow-1.hc.sbercloud.ru/v1/0b5a73ddd98027372f2ec00668b88856/todos/detail?offset=1&limit=10", ioutil.NopCloser(bytes.NewBuffer([]byte(""))))
